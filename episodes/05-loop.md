...
Here's a better approach: a [for loop](reference.html#for-loop)
...
We can call the [loop variable](reference.html#loop-variable) anything we like, but
...
The built-in function `enumerate` takes a sequence (e.g. a [list](04-lists/) and
