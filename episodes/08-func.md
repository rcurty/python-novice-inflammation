...
Inside the function,
we use a [return statement](reference.html#return-statement) to send a result
...
We refer to these variables as [local variables](reference.html#local-variable)
...
is said to be [global](reference.html#global-variable).
...
to add [comments](reference.html#comment) like this:
...
the [default value](reference.html#default-value) of 0.0:
...
it creates a [local variable](reference.html#local-variable)
