...
In Python, we can [assign](reference.html#assign) a value to a
[variable](reference.html#variable), using the equals sign `=`.
...
- are [case sensitive](reference.html#case-sensitive).
...
the language provides us with several built-in [functions](reference.html#function).
...
![](fig/python-sticky-note-variables-02.svg){alt='Value of 65.0 with weight\_kg label stuck on it, and value of 143.0 with weight\_lb labelstuck on it'}
